...
class MWMoviesController: MWViewController {
    ...
    private lazy var collectionView: UICollectionView = {
        ...
        view.register(MWMovieCell.self, forCellWithReuseIdentifier: MWMovieCell.reuseIndentifier)
...
extension MWMoviesController: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: MWMovieCell.reuseIndentifier, for: indexPath)
